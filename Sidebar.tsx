...
export default function Sidebar({ currentPhase, onPhaseClick, unlockedPhases }: SidebarProps) {
  ...
  return (
    <div className="hidden sm:flex w-20 border-r border-glass-border flex-col items-center py-4 gap-2 overflow-y-auto custom-scrollbar flex-shrink-0 bg-[#0f172a] h-full">
