  ...
  return (
    <header className="h-14 flex justify-between items-center px-4 bg-[#0b0e14] border-b border-glass-border z-50 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>
